...
function Navbar() {
  ...
  return (
    <>
      ...
      <nav
        className={`
          ${isSticky ? 'fixed top-0 left-0 right-0 rounded-none' : 'relative mt-4 mx-4 rounded-4xl hover:scale-105'}
      ...
      >
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <ul className="hidden md:flex items-center space-x-6">
            ...
            <li>
              <Link href="/contact" className="hover:text-gray-300 transition duration-300 flex items-center space-x-1">
                {/* Account Icon (User) */}
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        {isOpen && (
          <ul className="md:hidden flex flex-col items-center space-y-4 py-4 bg-green-200">
            <li>
              <Link href="/" className="hover:text-green-300 transition duration-300 flex items-center space-x-1">
                {/* Home Icon (Mobile) */}
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
